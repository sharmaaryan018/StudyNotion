          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                className="w-full rounded-[0.5rem] bg-richblack-500 p-[12px] pr-12 text-richblack-5"
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                id="lastName"
                placeholder="Enter first name"
                className="form-style w-full rounded-[0.5rem] bg-richblack-500 p-[12px] pr-12 text-richblack-5"
